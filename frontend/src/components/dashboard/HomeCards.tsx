  ...
  return (
    <div className="lg:flex sm:block gap-6">
      ...
      <section className='m-auto lg:w-9/12 w-full bg-indigo-100 p-8 my-5 m-w-90 rounded-lg shadow-lg sm:mb-5 sm:mx-auto'>
        ...
        <h2 className='text-md mb-3 font-semibold text-indigo-500' >Contribute by Verifying Your Digital Credentials</h2>
        <p className='text-md mb-3'>
          With your credentials, you can securely contribute to research initiatives and be part of groundbreaking medical discoveries.
        </p>
        <p className='text-md mb-3'>
